...
<%@include file='menu.html'%>    ​
        ...
        <div class="w3-bar w3-light-grey w3-border">
            ...
            <select class="w3-bar-item w3-select w3-border w3-right" name="choose">
                <c:forEach var="choose" items="${choose}">
                    <option value="${choose.name()}"${choose.name()==param.choose ? ' selected' : ''}>${choose.description}</option>
                </c:forEach>
            </select>
